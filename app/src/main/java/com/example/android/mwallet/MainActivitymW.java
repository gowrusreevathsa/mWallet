package com.example.android.mwallet;
...
public class MainActivitymW extends AppCompatActivity{
    ...
    protected void onCreate(Bundle savedInstanceState){
        ...
        setContentView(R.layout.activity_mainmw);
    ...
    private class GetHashesFromServerTask extends AsyncTask<String, String, PayuHashes> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            progressDialog = new ProgressDialog(MainActivitymW.this);
                ...
                new AlertDialog.Builder(this)
                        ...
                        .setPositiveButton(android.R.string.ok, new DialogInterface.OnClickListener() {
                            public void onClick(DialogInterface dialog, int whichButton) {
                                dialog.dismiss();
                                Intent intent = getPackageManager().getLaunchIntentForPackage("com.example.suraj.q_wallet.home");
